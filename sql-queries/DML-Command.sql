...
-- using DML commands : UPDATE , DELETE

UPDATE p_details
SET gender = 'MALE'
WHERE name = 'Amit Mishra';
UPDATE p_details
SET gender = 'MALE'
WHERE name = 'Kushaid';
UPDATE p_details
SET gender = 'MALE'
WHERE name = 'Pritam Anand';
UPDATE p_details
SET gender = 'MALE'
...
UPDATE p_details
SET gender = 'FEMALE'
WHERE name = 'Chanchal Rani';
UPDATE p_details
SET gender = 'FEMALE'
WHERE name = 'Rini Sarkar';
UPDATE p_details
SET gender = 'FEMALE'
WHERE name = 'Neha Sharma';
UPDATE p_details
SET gender = 'FEMALE'
WHERE name = 'Richa Devi';
UPDATE p_details
SET gender = 'FEMALE'
WHERE name = 'Iram Fatima';
SELECT *
FROM p_details;

class A{
    ...
    A(int x){
        System.out.println("---In parameterised constructor A---" + x);
    }
}
class B extends A{
    B(){
    ...
    B(int y){
        //super(1000);
        System.out.println("---In parameterised constructor B---" + y);
    }
}
public class SuperDemo {
    public static void main(String[] args){
        ...
        B obj = new B();  // No-Argument constructor of B is called
